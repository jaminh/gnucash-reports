;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; ability-to-pay.scm: balance sheet
;; 
...
(define-module (gnucash report standard-reports ability-to-pay))
...
(define reportname (N_ "Ability to Pay"))
...
;; options generator
(define (ability-to-pay-options-generator)
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; ability-to-pay-renderer
;; set up the document and add the table
;; then return the document or, if
;; requested, export it to a file
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;

(define (ability-to-pay-renderer report-obj choice filename)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
	  ...
	  (set! assets-less-liabilities (gnc:make-commodity-collector))
	  (assets-less-liabilities 'merge asset-balance #f)
	  (assets-less-liabilities 'minusmerge liability-balance #f)

	  (add-subtotal-line right-table (_ "Assets Less Liabilities") #f assets-less-liabilities)
	  ...
	  (if filename
	      (let* ((port (open-output-file filename)))
                (gnc:display-report-list-item
                 (list doc) port " ability-to-pay.scm ")
...
(gnc:define-report 
 'version 1
 'name reportname
 'report-guid "c4173ac99b2b448289bf4d11c731af14"
 'menu-path (list gnc:menuname-asset-liability)
 'options-generator ability-to-pay-options-generator
 'renderer (lambda (report-obj)
	     (ability-to-pay-renderer report-obj #f #f))
 'export-types #f
 'export-thunk (lambda (report-obj choice filename)
		 (ability-to-pay-renderer report-obj #f filename)))
