...
(define-module (gnucash reports standard ability-to-pay))
...
(define (ability-to-pay-renderer report-obj)
    ...
    (if (null? accounts)
        ...
        (let* ((asset-balance
               ...
               (assets-less-liabilities
				(gnc:collector- asset-balance liability-balance))
          ...
          (add-subtotal-line
           right-table (gnc:html-string-sanitize (G_ "Assets Less Liabilities"))
...
(gnc:define-report
 ...
 'renderer ability-to-pay-renderer)
